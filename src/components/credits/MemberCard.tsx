...
export default function MemberCard({ member }: { member: Member }) {
  return (
    <div className="flex h-[238px] w-full flex-col items-center gap-4 rounded-xl border border-border bg-surface p-5">
      {member.pinkBg ? (
      ...
      <div className="flex flex-col items-center gap-1.5">
        <h3 className="text-[18px] font-semibold leading-none tracking-[-0.36px] text-text">
          {member.name}
        </h3>
