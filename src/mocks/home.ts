...
export const MOCK_LINEUP: DayLineup[] = [
  ...
  },
  {
    ...
    schedules: [
      { name: 'KNU 가요제 및 시상식', startTime: '18:30', endTime: '19:30' },
      ...
      { name: "축하공연 'AMbiO'", startTime: '21:00', endTime: '21:30' },
      { name: "축하공연 'NCT WISH'", startTime: '21:30', endTime: '22:00' },
      { name: "축하공연 '권은비'", startTime: '22:00', endTime: '22:30' },
    ],
  },
  {
    day: 22,
    ...
    schedules: [
      ...
      { name: "축하공연 '지코'", startTime: '19:30', endTime: '20:00' },
      { name: "축하공연 '아이칠린'", startTime: '20:00', endTime: '20:30' },
